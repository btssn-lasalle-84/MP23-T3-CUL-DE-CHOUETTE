...
void Ihm::afficherGagnant(std::string nomDujoueur, unsigned int numeroDeTour) const
{
    std::cout << "Le gagnant est : " << nomDujoueur 
              << " en " << numeroDeTour << " tour !" 
              <<" Bravo à lui ! " << std::endl;
}
